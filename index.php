...
<?php
	$page=@$_GET['page'];
	$pages=array('login', 'benutzerverwaltung', 'bilder', 'bilderuc', 'bildererror', 'rangliste', 'upload', 'uploadimg', 'uploadvid', 'userprofile', 'userprofiledc', 'videos', 'videosuc', 'pwforgot');
